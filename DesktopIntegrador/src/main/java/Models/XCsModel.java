...
public class XCsModel implements java.io.Serializable {
    ...
    public XCsModel(int id, XDireccionModel XDireccionModel, String telefono, String name) {
        this.id = id;
    ...
    public XCsModel(int id, XDireccionModel XDireccionModel, String telefono, String name, Set XDependienteModels) {
        this.id = id;
        this.XDireccionModel = XDireccionModel;
        this.telefono = telefono;
        this.name = name;
