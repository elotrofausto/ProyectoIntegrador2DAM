...
/**
 * XDependienteModel generated by hbm2java
 */
public class XDependienteModel  implements java.io.Serializable {
    ...
    public XDependienteModel(int id, XPersonaModel XPersonaModel, XViviendaModel XViviendaModel, String password, String genero, Date fecNacim, String nss, Date fecAlta) {
        this.id = id;
    ...
    public XDependienteModel(int id, XCsModel XCsModel, XMedicoModel XMedicoModel, XPersonaModel XPersonaModel, XViviendaModel XViviendaModel, String password, String genero, Date fecNacim, String nss, Date fecAlta, Integer createUid, Date createDate, Integer writeUid, Date writeDate, Set XLlamadaModels, Set XAlarmaModels, Set XViviendaModels, Set XAvisoModels, Set XEstadoModels, Set XGeolocalizModels, Set XHistmedicoModels, Set XContactofamiliarModels) {
       this.id = id;
    ...
    public String toString() {
        return "XDependienteModel{" + "id=" + id + ", XCsModel=" + XCsModel + ", XMedicoModel=" + XMedicoModel + ", XPersonaModel=" + XPersonaModel + ", password=" + password + ", genero=" + genero + ", fecNacim=" + fecNacim + ", nss=" + nss + ", fecAlta=" + fecAlta + ", XLlamadaModels=" + XLlamadaModels + ", XAlarmaModels=" + XAlarmaModels + ", XViviendaModels=" + XViviendaModels + ", XAvisoModels=" + XAvisoModels + ", XEstadoModels=" + XEstadoModels + ", XGeolocalizModels=" + XGeolocalizModels + ", XHistmedicoModels=" + XHistmedicoModels + ", XContactofamiliarModels=" + XContactofamiliarModels + '}';
    }
