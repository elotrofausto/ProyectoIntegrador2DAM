...
/**
 * XEstadoModel generated by hbm2java
 */
public class XEstadoModel  implements java.io.Serializable {
    ...
    public XEstadoModel(int id, XDependienteModel XDependienteModel, Date fechaHora, Date fechaHoraInicio, String descripcion, Integer createUid, Date createDate, Integer writeUid, Date writeDate) {
       this.id = id;
       this.XDependienteModel = XDependienteModel;
    ...
    public String toString() {
        return "XEstadoModel{" + "id=" + id + ", XDependienteModel=" + XDependienteModel + ", fechaHora=" + fechaHora + ", fechaHoraInicio=" + fechaHoraInicio + ", descripcion=" + descripcion + '}';
    }
